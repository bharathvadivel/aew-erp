...
<head>
	...
	<title>ERP - Lucabooks - Login</title>
...
<body style="background: url({{ asset('login/img/login-bg.jpg') }}) center center/cover no-repeat;">
					...
					<div class="fxt-content">
						...
						<!-- 	<ul class="fxt-socials">
							...
							<div class="fxt-style-line">
								<h3 style="color:#146B71;font-weight: 700;">WELCOME BACK</h3> 
							</div>
						</div>
						<div class="fxt-form">
