        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Edit Item</h5>
                            <hr>
                            <form method="post" action="{{url('material_update')}}">
                                @csrf

                                <input type="text" value="{{$material->id}}" required="" name="id" id="material_id" style="display: none;">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="item_group_code" class="form-control">
                                                ...
                                                @foreach ($item_groups as $key)
                                                    <option value="{{$key->item_group_code}}" {{ $material->item_group_code == $key->item_group_code ? 'selected' : '' }}>{{$key->item_group_code}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" value="{{$material->material_code}}" required="" name="material_code" id="material_code" class="form-control" placeholder="Item Code">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" value="yes" type="radio" id="consider_build1" name="consider_build" {{$material->consider_build_count === 'yes' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="consider_build1" style="margin-right:15px;">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" value="no" type="radio" id="consider_build2" name="consider_build" {{$material->consider_build_count === 'no' ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$material->item_group_desc}}" required="" name="item_group_desc" class="form-control" placeholder="Item Group Description">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$material->material_desc}}" required="" name="material_desc" class="form-control" placeholder="Item Description">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        <option value="">Select Unit</option>
                                        <option value="Casting" {{$material->category == 'Casting' ? 'selected' : ''}}>Casting</option>
                                        <option value="Rough Casting" {{$material->category == 'Rough Casting' ? 'selected' : ''}}>Rough Casting</option>
                                        <option value="Machining Ref" {{$material->category == 'Machining Ref' ? 'selected' : ''}}>Machining Ref</option>
                                        <option value="Packing" {{$material->category == 'Packing' ? 'selected' : ''}}>Packing</option>
                                        <option value="Rotor with Shaft" {{$material->category == 'Rotor with Shaft' ? 'selected' : ''}}>Rotor with Shaft</option>
                                        <option value="SS Body" {{$material->category == 'SS Body' ? 'selected' : ''}}>SS Body</option>
                                        <option value="Stampings" {{$material->category == 'Stampings' ? 'selected' : ''}}>Stampings</option>
                                        <option value="Store items" {{$material->category == 'Store items' ? 'selected' : ''}}>Store tems</option>
                                        <option value="Winding" {{$material->category == 'Winding' ? 'selected' : ''}}>Winding</option>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="uom" class="form-control">
                                                ...
                                                @foreach ($units as $key)
                                                    <option value="{{$key->unit_code}}" {{ $material->uom == $key->unit_code ? 'selected' : '' }}>{{$key->unit_code}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$material->total_stock_qty}}" required="" name="total_stock_qty" class="form-control" placeholder="Total Stock Qty">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select onchange="model(this.value)" name="model_code" class="form-control">
                                                <option value="">Click Product To Add Suitable Model</option>
                                ...
                                <div class="table-responsive datatable-primary">
                                    <table id="dataTable" class="table text-center table-striped table-bordered" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($compatibleModels as $key=>$vl)
                                            <tr>
                                                <td>
                                                    <input style="background: #e0e0e0;" class="suitableModelCode1 form-control" type="text" name="suitable_model_code1" id="suitable_model_code1" value="{{$vl->model_code}}" readonly>
                                                </td>
                                                <td>
                                                    <input style="background: #e0e0e0;" class="qty1 form-control" type="text" name="min_assembly_qty_set1" id="min_assembly_qty_set1" value="{{$vl->min_assembly_qty_set}}" readonly>
                                                </td>
                                                <td class="editc">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#material_code').on('input', function () {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('check.material.duplicate.edit.page') }}", // Replace with your actual route
                data: {
    ...
    function insertRow() {
        ...
        var consider_build = $('input[name="consider_build"]:checked').val();
