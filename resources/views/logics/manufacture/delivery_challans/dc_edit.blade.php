        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Edit Delivery Challan
                                <a href="{{ route('dc.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage DC</a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('dc.update')}}">
                                @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea readonly style="border: none;width:100%" rows="5" class="forBillingAddress" id="forBillingAddress" name="forBillingAddress">{{$dcs->customer_bill_address}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forShippingAddress">Shipping Address:</label>
                                                    <textarea readonly style="border: none;width:100%" rows="5" class="forShippingAddress" id="forShippingAddress" name="forShippingAddress">{{$dcs->customer_ship_address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly style="border: none;" id="forCustomerMobileNo" class="phone" name="customer_mobile" value="{{$dcs->customer_mobile_no}}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forGSTNo">GSTIN No:</label>
                                                    <input readonly style="border: none;" id="forGSTNo" class="gstin_no" name="customer_gst_no" value="{{$dcs->customer_gst_no}}"/>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="forTermsofDelivery" type="text" name="forTermsofDelivery" class="form-control" rows="5">{{$dcs->terms_of_delivery}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forInvoiceDate" type="date" value="{{date('Y-m-d',strtotime($dcs->dc_date))}}" name="dc_date" class="form-control" placeholder="Date">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forBuyerOrderNo" type="text" value="{{$dcs->buyer_order_no}}" name="forBuyerOrderNo" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forBuyerOrderDate" type="date" value="{{ $dcs->buyer_order_date ? date('Y-m-d', strtotime($dcs->buyer_order_date)) : '' }}" name="forBuyerOrderDate" class="form-control" placeholder="Date">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forDispatchDocNo" value="{{$dcs->dispatch_doc_no}}" type="text" name="forDispatchDocNo" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forDispatchedThrough" value="{{$dcs->dispatch_through}}" type="text"  name="forDispatchedThrough" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forDestination" type="text" value="{{$dcs->destination}}" name="forDestination" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive datatable-primary">
                                    <table id="dataTable" class="table text-center table-striped table-bordered" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($dc_details as $key=>$vl)
                                                <tr>
                                                    
                                                    <td style="max-width:150px;">
                                                        <input style="display: none;" class="itemType3" type="text" name="item_type3" id="itemType3" value="{{$vl->item_type}}">
                                                        <input readonly="" class="item_code1 form-control" type="text" name="item_code1" id="item_code1" style="border:none;background: none;" value="{{$vl->item_code}}">
                                                    </td>
                                                    <td>
                                                        <textarea readonly="" class="item_desc1 form-control" type="text" name="item_desc1" id="item_desc1" style="border:none;background: none;">{{$vl->item_desc}}</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea readonly="" class="item_addl_desc1 form-control" type="text" name="item_addl_desc1" id="item_addl_desc1" style="border:none;background: none;">{{$vl->item_additional_desc}}</textarea>
                                                    </td>
                                                    <td style="max-width:150px;">
                                                        <input readonly="" class="item_hsnsac_code1 form-control" type="text" name="item_hsnsac_code1" id="item_hsnsac_code1" style="border:none;background: none;" value="{{$vl->item_hsnsac_code}}">
                                                    </td>
                                                    <td class="text-left" style="max-width:80px;">
                                                        <input readonly="" class="qty1 form-control" type="text" name="qty1" id="qty1" style="border:none;background: none;" value="{{$vl->item_qty}}">
                                                    </td>
                                                    <td style="max-width:80px;">
                                                        <input readonly="" class="item_uom1 form-control" type="text" name="item_uom1" id="item_uom1" style="border:none;background: none;" value="{{$vl->item_uom}}">
                                                    </td>
                                                    <td style="max-width:120px;">
                                                        <input readonly="" class="rate1 form-control" type="text" name="rate1" id="rate1" style="border:none;background: none;" value="{{$vl->item_price}}">
                                                    </td>
                                                    <td style="max-width:120px;">
                                                        <input readonly="" class="amount1 form-control" type="text" name="amount1" id="amount1" style="border:none;background: none;" value="{{$vl->item_sub_total}}">
                                                    </td>
                                                    <td class="editc">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="forClientNote" name="forClientNote" rows="3">{{$dcs->client_note}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="forRemarks">Remarks</label>
                                                        <textarea class="form-control" id="forRemarks" name="forRemarks" rows="3">{{$dcs->remarks}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table style="float: right;">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input id="subTotal" type="number" name="subTotal" class="form-control subTotal" style="border: 0px;" value="{{$dcs->subtotal}}" readonly>
                                                        </td>
                                                    </tr>
                                                    <!-- <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input id="forDiscount" type="number" name="discount" class="form-control discount" placeholder="Discount" value="{{$dcs->discount}}">
                                                            <span style="font-size:12px;color:red">Note: Enter Amount Value</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: 16px;">GST :</td>
                                                        <td><input style="width: 100px;" id="gstPercentage" type="number" step="0.01" name="gstPercentage" class="form-control gstPercentage" value="{{$dcs->gst_percentage}}"></td>
                                                        <td style="font-size: 16px;">
                                                            <input id="gstAmount" type="number" step="0.01" name="gstAmount" class="form-control gstAmount" value="{{$dcs->taxable_value}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input id="netTotal" type="number" name="netTotal" class="form-control netTotal" style="border: 0px;" value="{{$dcs->net_total}}" readonly>
                                                        </td>
                                                    </tr> -->
                                                </tbody>
                                            </table>
