        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Order Master
                                <a href="{{ route('manage.orders') }}"class="btn btn-primary btns"><i class="fa fa-th-list"></i> Manage Orders </a>
                                        ...
                                        @foreach ($customers as $key => $customer)
                                            <tr>
                                                <td style="text-align:center;">
                                                    <a href="{{route('orders.by.customer.id',$customer->id)}}" style="text-align:center;font-weight: bold;color:blue;cursor:pointer;border-bottom: 1px dashed grey;">
