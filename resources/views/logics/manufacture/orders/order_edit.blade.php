        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Update Order
                                <a href="{{ route('order.master') }}" class="btn btn-primary btns">Manage Orders</a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('order.update')}}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forInvoiceNo">Order No <span style="color:red">&#9733;</span></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forInvoiceDate">Order Date</label>
    ...
    *===========================-->
    ...
    <script  type="text/javascript">
        ...
        function model(model_no) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('order.product.select')}}",
                data: {
                    model_no: model_no,
                },
