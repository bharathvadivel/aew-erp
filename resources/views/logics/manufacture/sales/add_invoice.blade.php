                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Add Invoice
                                <a href="{{ route('invoice.master') }}" class="btn btn-primary btns">Manage invoices</a>
                            </h5>
                            <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forDeliveryNote" type="text" name="forDeliveryNote" class="form-control forDeliveryNote">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <div class="form-group">
                                                    <label for="forDeliveryNoteDate">Delivery Note Date</label>
                                                    <input id="forDeliveryNoteDate" type="date" name="forDeliveryNoteDate" class="form-control forDeliveryNoteDate" placeholder="Date">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forTermsPayment" type="text" name="forTermsPayment" class="form-control forTermsPayment">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forBuyerOrderNo" type="text" name="forBuyerOrderNo" class="form-control forBuyerOrderNo">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forBuyerOrderDate" type="date" name="forBuyerOrderDate" class="form-control forBuyerOrderDate" placeholder="Date">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forDispatchDocNo" type="text" name="forDispatchDocNo" class="form-control forDispatchDocNo">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forDispatchedThrough" type="text" name="forDispatchedThrough" class="form-control forDispatchedThrough">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="forDestination" type="text" name="forDestination" class="form-control forDestination">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="forClientNote" name="forClientNote" rows="3">We declare that this invoice shows actual price of the goods described and that all particulars are true and correct.</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                        </div>
                                            ...
                                            <table style="float: right;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input id="forDiscount" type="number" name="discount" value="0" class="form-control discount" placeholder="Discount">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input id="taxTotal" type="number" name="taxTotal" class="form-control taxTotal" style="border: 0px;" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: 16px;">GST :</td>
                                                        <td><input style="width: 100px;" id="gstPercentage" type="number" step="0.01" name="gstPercentage" class="form-control gstPercentage"></td>
                                                        <td style="font-size: 16px;">
                                                            <input id="gstAmount" type="number" step="0.01" name="gstAmount" class="form-control gstAmount" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input id="netTotal" type="number" name="netTotal" class="form-control netTotal" style="border: 0px;" readonly>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
