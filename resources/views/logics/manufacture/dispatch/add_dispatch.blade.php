        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Create Dispatch
                                <a href="{{ route('manage.dispatch') }}" class="btn btn-primary btns">Manage Dispatch</a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('dispatch.store')}}">
                                @csrf
                                <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="forCustomerName" required="" onchange="getCustomer(this.value)" name="customer_name" class="form-control customer_name selectsearch">
                                                        ...
                                                        @foreach ($customers as $key => $vl)
                                                            <option value="{{ $vl->id }}">{{ $vl->customer_name }} - {{ $vl->customer_type }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    ...
                                                    <span>Available Stock: <label class="totalQty" name="totalQty" id="totalQty"></label></span>
                                                </td>
                                                <td class="uom"></td>
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                <label for="forClientNote">Remarks</label>
