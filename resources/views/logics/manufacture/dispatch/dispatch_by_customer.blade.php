                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endphp
                            <h4 class="header-title">Dispatch History by {{$getContact->customer_name}}
                                <a href="{{ route('manage.dispatch') }}"class="btn btn-primary btns"><i class="fa fa-th-list"></i> Dispatch Master </a>
                                <a href="{{ route('manage.dispatch') }}"class="btn btn-primary btns mr-2"><i class="fa fa-th-list"></i> Manage Dispatch </a>
