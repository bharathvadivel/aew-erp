        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Update Dispatch
                                <a href="{{ route('dispatch.master') }}" class="btn btn-primary btns">Manage Dispatch</a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('dispatch.update')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="forCustomerName" required="" onchange="getCustomer(this.value)" name="customer_name" class="form-control customer_name selectsearch">
                                                        ...
                                                        @foreach ($customers as $key => $vl)
                                                            <option value="{{ $vl->id }}" @if ($vl->id == $customer_id) selected @endif>{{ $vl->customer_name }} - {{ $vl->customer_type }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        @php
                                            $getContact = DB::table('contacts')->where('id',$customer_id)->first();
                                        @endphp
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forBillingAddress">Billing Address:</label>
                                                    <textarea readonly style="border: none;width:100%" rows="5" class="forBillingAddress" id="forBillingAddress" name="forBillingAddress">{{$getContact->customer_billing_address}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forShippingAddress">Shipping Address:</label>
                                                    <textarea readonly style="border: none;width:100%" rows="5" class="forShippingAddress" id="forShippingAddress" name="forShippingAddress">{{$getContact->customer_shipping_address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly style="border: none;" id="forCustomerMobileNo" class="phone" name="customer_mobile" value="{{$getContact->customer_mobile_no}}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forGSTNo">GSTIN No:</label>
                                                    <input readonly style="border: none;" id="forGSTNo" class="gstin_no" name="customer_gst_no" value="{{$getContact->customer_gst_no}}"/>
                                                </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forInvoiceNo">Dispatch No <span style="color:red">&#9733;</span></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="forInvoiceDate">Dispatch Date</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group">
                                            <label class="form-check-label mr-3">Select Model:</label>
                                            ...
                                            <select id="forModelNo" onchange="model(this.value)" name="model_no" class="form-control model_no selectsearch">
                                                ...
                                                @foreach ($models as $key => $mod)
                                                    <option value="{{$mod->model_code}}">{{$mod->model_code}} - {{$mod->model_desc}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
    ...
    *===========================-->
    ...
    <script  type="text/javascript">
        function remove(id) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('dispatch.item.remove')}}",
                data: {
                    id: id,
                },
        ...
        function model(model_no) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('dispatch.product.select')}}",
                data: {
                    model_no: model_no,
                },
        ...
        function insertRow() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('dispatch.item.insert')}}",
                data: {
                    invoiceNo: invoiceNo,
