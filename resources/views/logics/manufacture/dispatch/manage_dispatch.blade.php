        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Manage Dispatch
                                <a href="{{ route('dispatch.master') }}"class="btn btn-primary btns"><i class="fa fa-th-list"></i> Dispatch Master </a>
                                <a href="{{ route('add.dispatch') }}" class="btn btn-primary btns mr-2"><i class="fa fa-plus-circle"></i> Create Dispatch </a>
                            </h4>
                            <br>
                            <form method="POST" action="{{route('manage.dispatch')}}">
                                @csrf
                                <div class="form-row">
                                ...
                                <table id="dataTable" class="text-center" style="width: 100%">
                                    <thead class="text-capitalize">
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Dispatch No.</th>
                                            <th style="text-align: center;">Dispatch Date</th>
                                            <th style="text-align: center;">No. Of Models in This Dispatch</th>
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            $indetail = DB::table('dispatch_details')->where('invoice_no',$vl->invoice_no)->get();
                                            $inv_item_qty = DB::table('dispatch_details')->select(DB::raw('count(invoice_no) as qty'))->where('invoice_no', $vl->invoice_no)->value('qty');
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;" class="editc">
                                                <a href="{{route('dispatch.edit',$vl->invoice_no)}}"><i  data-placement="top" title="Edit" class="fa fa-edit" style="color:#056c91"></i></a>
                                                <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('dispatch.delete',$vl->invoice_no)}}" method="POST">
