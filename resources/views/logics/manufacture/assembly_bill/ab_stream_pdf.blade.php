                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered" style="width: 100%; vertical-align: middle;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 15%;text-align:center;">TAX INVOICE</th>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td rowspan="3" style="width: 60%;">Billing To:</span><br>
                                                            <p>
                                                                <span style="font-size:18px;font-weight: 700;">{{$invoices->customer_name}}</span><br>
                                                                {{$invoices->customer_bill_address}}<br>
                                                                Phone: {{$invoices->customer_mobile_no}}<br>
                                                                GSTIN: {{$invoices->customer_gst_no}}
                                                            </p>
                                                        </td>
                                                        <td style="">Invoice No:<br><span style="font-weight: 700;">{{$invoice_no}}</span></td>
                                                        <td style="">Invoice Date:<br><span style="font-weight: 700;">{{date('d-m-Y', strtotime($invoices->invoice_date))}}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="">Buyer Order No:<br><span style="font-weight: 700;"></span></td>
                                                        <td style="">Invoice Due Date:<br><span style="font-weight: 700;">{{date('d-m-Y', strtotime($invoices->invoice_due_date))}}</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table table-bordered" style="width: 40%;vertical-align:middle;float:right;">
                                                <tbody>                                                        
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;">₹{{$invoices->billing_price}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: left;font-weight: 700;">CGST @ {{number_format(abs($invoices->gst_percentage / 2))}}%</td>
                                                        <td style="text-align: right;">₹{{$invoices->cgst}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: left;font-weight: 700;">SGST @ {{number_format(abs($invoices->gst_percentage / 2))}}%</td>
                                                        <td style="text-align: right;">₹{{$invoices->cgst}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: left;font-weight: 700;">Net Payable</td>
                                                        <td style="text-align: right;">₹{{$invoices->net_total}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table table-bordered" style="width: 100%;vertical-align: middle;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="width:50%;">Client Note:<br>{{$invoices->client_note}}</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td style="width:50%;">Disclaimer:<br>We declare that this invoice shows the actual price of the goods described and that all particulars are true and correct.</td>
