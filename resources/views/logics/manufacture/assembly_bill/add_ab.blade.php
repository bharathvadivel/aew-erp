        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Add Assembly Bill
                                <a href="{{ route('ab.master') }}" class="btn btn-primary btns">Manage Assembly Bill</a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('ab.store')}}">
                                @csrf
                                <div class="row">
