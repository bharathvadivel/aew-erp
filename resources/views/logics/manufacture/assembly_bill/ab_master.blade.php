        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Manage Assembly Bills
                                <a href="{{ route('add.ab') }}"class="btn btn-primary btns"><i class="fa fa-plus-circle"></i> Create Bill </a>
                                <a href="{{ route('assembly.bill.import') }}"class="btn btn-primary btns mr-2"><i class="fa fa-download"></i> Import Bill</a>
                            </h4>
                            <br>
                                    ...
                                    <tbody>
                                        @foreach ($invoices as $key => $vl)
                                            <tr>
                                                ...
                                                <td>{{ $details_grouped[$vl->invoice_no] ?? 0 }}</td>
                                                <td class="editc">
                                                    <a href="{{ route('ab.edit', $vl->invoice_no) }}">
                                                        <i data-placement="top" title="Edit" class="fa fa-edit" style="color:#056c91"></i>
                                                    </a>
                                                    <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('ab.delete', $vl->invoice_no) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button>
                                                            <i data-placement="top" title="Delete" class="fa fa-trash" style="color:red"></i>
                                                        </button>
                                                    </form>
                                                </td>
                                            </tr>
