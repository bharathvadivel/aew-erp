        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Add Inward Invoice
                                <a href="{{ route('inwd.invoice.master') }}" class="btn btn-primary btns">Manage Inward Invoices</a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('inwd.invoice.store')}}">
                                @csrf
                                <div class="row">
    ...
    *===========================-->
    ...
    <script  type="text/javascript">
        ...
        $('#dataTable').on('click', '.delete-row', function() {
            ...
            var itemPrice = $(this).closest('tr').find('.rate1').val();
