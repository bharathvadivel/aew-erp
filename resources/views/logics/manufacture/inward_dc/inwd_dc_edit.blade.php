        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Edit Inward DC
                                <a href="{{ route('inwd.dc.master') }}" class="btn btn-primary btns">Manage Inward DCs</a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('inwd.dc.update')}}">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="cust_order_date" type="date" name="cust_order_date" class="form-control" placeholder="Date" value="{{date('Y-m-d',strtotime($invoices->customer_bill_date))}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input hidden id="invoice_type" value="invoice" type="text" name="invoice_type" class="form-control invoice_type" value="dc" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <table id="dataTable" class="table text-center table-striped table-bordered" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($invoice_details as $key=>$vl)
                                                <tr>
                                                    <td>
                                                        <input style="display: none;" class="itemType3" type="text" name="itemType3" id="itemType3" value="{{$vl->item_type}}">
                                            ...
                                            <table style="float: right;">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="estAmount" type="number" name="estAmount" class="form-control estAmount" value="{{$invoices->estimated_amount}}"/>
                                                        </td>
                                                    </tr>
