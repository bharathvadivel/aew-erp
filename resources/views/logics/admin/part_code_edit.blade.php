            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Edit Spare Parts Details
                                    {{-- <a href="{{ route('part.code.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage Part Details</a> --}}
                                </h5>
                            </center>
                            <hr>
                            <form method="post" action="{{route('update.part.codes')}}">
                                @csrf
                                <input type="hidden" class="form-control" value="{{$parts_list->id}}" name="id">

                                <div class="form-group">
                                    <label for="disabledTextInput">Spare Part Code <span style="color:red">&#9733;</span></label>

                                    <input type="text" required="" value="{{$parts_list->part_code}}" name="part_code" placeholder="Part Code" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required="" value="{{$parts_list->part_name}}" name="part_name" placeholder="Part Name" class="form-control">
                                    ...
                                    <div class="col-md-12 mb-12">
                                        <div class="form-group">
                                            ...
                                            <select id="choices-multiple-remove-button" placeholder="Select model" multiple name="model_no[]" class="form-control ">
                                                ...
                                                <option {{in_array($vl->model_no,$old_model) ? 'selected':''}} value="@php echo $vl->model_no @endphp">@php echo $vl->model_no @endphp </option>;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required="" value="{{$parts_list->hsn_code}}" name="hsn_code" placeholder="HSN Code" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select required="" name="part_category" class="form-control selectsearch">
                                        ...
                                        <option {{$key->id==$parts_list->category_id ? 'selected':''}} value="{{ $key->id }}">{{ $key->category_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="disabledTextInput">Part Price <span style="color:red">&#9733;</span></label>
                                    <input type="number" value="{{$parts_list->price}}" min="1" required="" name="part_price" class="form-control" placeholder="Spare Parts Price">

                                </div>

                                <div class="form-group">
                                    <label for="disabledTextInput">Gst Percentage% <span style="color:red">&#9733;</span></label>
                                    <input type="text" value="{{$parts_list->gst_percentage}}" required="" name="gst" class="form-control" placeholder="Gst Percentage">
