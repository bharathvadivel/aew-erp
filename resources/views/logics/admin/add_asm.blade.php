            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Add Area sales manager
                                    <a href="{{ route('asm.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage ASM</a>
                                </h5>
                            </center>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('asm.store')}}">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">ASM-ID <span style="color:red">&#9733;</span></label>
                                            <input readonly value="{{$asm_id}}" type="text" name="asm_id" class="form-control  @error('asm_id') is-invalid @enderror" placeholder="ASM ID">
                                            @error('asm_id')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('dob')}}" type="date" name="dob" class="form-control @error('dob') is-invalid @enderror">
                                            @error('dob')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('phone')}}" required="" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone">
                                            @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="disabledSelect">Direct Partners <span style="color:red">&#9733;</span></label>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="partner_id[]" type="checkbox" value="{{$key->partner_id}}">
