            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Add Sales Executive 
                                    <a href="{{ route('sales_executive.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage Sales Executive</a>
                                </h5>
                            </center>
                            <hr>
                            <form method="post" action="{{route('sales_executive.store')}}">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Sales Executive-ID</label>
                                            <input readonly value="{{$se_id}}" type="text" name="sales_executive_id" class="form-control" placeholder="Sales Executive ID">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" type="text" name="pin_code" class="form-control" placeholder="Pincode">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Phone</label>
                                            <input type="text" onkeypress="return /[0-9]/i.test(event.key)" minlength="10" maxlength="10" name="phone" required class="form-control" placeholder="Phone">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
