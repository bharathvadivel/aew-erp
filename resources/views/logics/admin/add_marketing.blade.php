            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Add marketing creatives
                                    <a href="{{ route('marketing.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage Marketing Creatives</a>
                                </h5>
                            </center>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('marketing.store')}}">
                                @csrf
                                ...
                                <center>
                                    <h5 class="card_title " style="color:#50aaca"> Marketing creatives image <span style="color:red">&#9733;</span> </h5>
                                </center>


                                <div class="form-group dropzone">
                                    <img src="{{asset('user/images/upload.svg')}}" class="upload-icon" />
                                    <input required="" multiple type="file" name="posts[]" class="form-control upload-input">
                ...
                <style>
                    ...
                    @keyframes hop {
                        ...
                        25% {
                            transform: scale(1.05, .9) translateY(-100%)
                        }
