                                ...
                                <div style="margin:101px 0px 0px 0px " class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <div class="row">
                                                @php
                                                $login_id=$disinvoices[0]->created_by;
                                                $from = DB::table('warehouses')->where('warehouse_id',$login_id)->first();
                                                @endphp

                                                <div class="col-md-12">
                                                    <h4 style="text-align: right">{{$vl->bill_type==0 ? 'TAX INVOICE':'DELIVERY NOTE' }}</h4>

                                                    <div class="invoice-title-edit">
                                                        <img style="max-width: 9%;height: 32px;" src="{{asset('login/img/logo1.png')}}" alt="logo">
                                                        <h4 style="font-size: 19px;margin:-5px 0px 0px 80px" class="font-16"><strong>{{$from->name}}</strong></h4>
                                                        <h4 style="font-size: 16px;" class="font-16 pull-right"><strong>Invoice No:{{$disinvoices[0]->disinvoice_no}}</strong></h4>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                @php
                                                                $dis_id=$disinvoices[0]->dis_id;
                                                                $location_id=$disinvoices[0]->location_id;
                                                                $billto = DB::table('distributors')->where('partner_id',$dis_id)->first();
                                                                $billto_location = DB::table('userlocations')->where('partner_id',$dis_id)->where('location_id',$location_id)->first();
                                                                @endphp
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="ship">
                                                                @php
                                                                $dis_id=$disinvoices[0]->dis_id;
                                                                $delivery_location_id=$disinvoices[0]->delivery_location_id;
                                                                $shipped= DB::table('distributors')->where('partner_id',$dis_id)->first();
                                                                $shipped_location = DB::table('userlocations')->where('partner_id',$dis_id)->where('location_id',$delivery_location_id)->first();
                                                                @endphp
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">@if($shipped_location) {{$shipped_location->address}} @endif</span>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        @php
                                                        $by_order_no=$disinvoices[0]->by_order_no!='' ?$disinvoices[0]->by_order_no :$by_order_no='---';
                                                        $date=$disinvoices[0]->date!='' ? date('d-m-Y',strtotime($disinvoices[0]->date)):$date='---';
                                                        $ew_bill_no=$disinvoices[0]->ew_bill_no!='' ? $disinvoices[0]->ew_bill_no:$ew_bill_no='---';
                                                        $others=$disinvoices[0]->others!='' ? $disinvoices[0]->others:$others='---';
                                                        @endphp
                                                            ...
                                                            <div class="panel panel-default">
                                                                        ...
                                                                        <table border="1" class="table borderclr table-bordered">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    @if($disinvoices[0]->state=='TAMILNADU' )
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                $s_list=DB::table('disserials')->where('disinvoices_id',$vl->id)->pluck('serial_no')->toArray();
                                                                                ...
                                                                                @endforeach
                                                                                @if ($disinvoices[0]->tcs!=0)
                                                                                @php
                                                                                $set_total=($sub_total/100)*$disinvoices[0]->tcs;
                                                                                $net_total=$pay+$set_total;
                                                                                $set_tcs=$disinvoices[0]->tcs."%";
                                                                                @endphp
                                                                                @else
                                                                                @php
                                                                                $set_total=0;
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th style="text-align:end" rowspan="2" colspan="8">
                                                                                        {{$from->name}}
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="text-right">{{number_format($disinvoices[0]->round_off,2)}}</th>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="text-right">{{number_format($disinvoices[0]->grand_total,2)}}</th>

                                                                                </tr>

                                                                                <tr>
                                                                                    <th colspan="11" style="text-transform: uppercase;word-break: break-all;">Amount in words : {{App\Http\Controllers\AdminController::words($disinvoices[0]->grand_total)}} ONLY</th>
                                                                ...
                                                                <div class="d-print-none">
                                                                    <div class="pull-right">
                                                                        <a href="{{url('generatepdf/'.$disinvoices[0]->disinvoice_no)}}" target="_blank" class="btn btn-success waves-effect waves-light "></i>Print</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
