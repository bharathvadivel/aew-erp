            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Add Employee
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="{{$emp_id}}" type="text" name="emp_id" class="form-control @error('emp_id') is-invalid @enderror" placeholder="Employee ID">
                                            @error('emp_id')
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('a_name')}}" name="a_name" class="form-control @error('a_name') is-invalid @enderror" placeholder="Father/Guardian/Spouse Name">
                                            @error('a_name')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('a_phone')}}" name="a_phone" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10" class="form-control @error('a_phone') is-invalid @enderror" placeholder="Father/Guardian/Spouse Mobile No">
                                            @error('a_phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9 mb-9">
                                        <div class="form-group">
                                            ...
                                            <textarea required="" type="text" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Address">{{old('address')}}</textarea>
                                            @error('address')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('dob')}}" type="date" name="dob" class="form-control @error('dob') is-invalid @enderror" placeholder="Date of birth">
                                            @error('dob')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('phone')}}" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10" type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Personal Mobile No">
                                            @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('e_phone')}}" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10" type="text" name="e_phone" class="form-control  @error('e_phone') is-invalid @enderror" placeholder="Emergency Conatct No">
                                            @error('e_phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('bank')}}" type="text" name="bank" class="form-control @error('bank') is-invalid @enderror" placeholder="Bank Name">
                                            @error('bank')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('account_no')}}" type="text" name="account_no" class="form-control @error('account_no') is-invalid @enderror" placeholder="Bank Account No.">
                                            @error('account_no')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('ifsc_code')}}" type="text" name="ifsc_code" class="form-control @error('ifsc_code') is-invalid @enderror" placeholder="IFSC Code">
                                            @error('ifsc_code')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('branch')}}" type="text" name="branch" class="form-control @error('branch') is-invalid @enderror" placeholder="Branch Name ">
                                            @error('branch')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('passport_no')}}" name="passport_no" class="form-control @error('passport_no') is-invalid @enderror" placeholder="Passport No">
                                            @error('passport_no')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('doj')}}" type="date" name="doj" class="form-control @error('doj') is-invalid @enderror" placeholder="Date of joining ">
                                            @error('doj')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('blood_group')}}" type="text" name="blood_group" class="form-control @error('blood_group') is-invalid @enderror" placeholder="Blood Group">
                                            @error('blood_group')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('aadhar_no')}}" type="text" name="aadhar_no" class="form-control @error('aadhar_no') is-invalid @enderror" placeholder="Aadhar No">
                                            @error('aadhar_no')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('employee_type')}}" list="type" type="text" name="employee_type" placeholder="Employee Type" class="form-control @error('employee_type') is-invalid @enderror">
                                            @error('employee_type')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
