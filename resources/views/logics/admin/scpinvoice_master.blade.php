                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('scpinvoice.master')}}">
                                ...
                                <div class="form-row">
                                    ...
                                    <!-- <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Warehouse Executive</label>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Service Partner</label>
                                ...
                                <table id="dataTable" class="text-center boh">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ ($vl->partners) ? $vl->partners->service_center_name: ($vl->towarehouse ? $vl->towarehouse->name:'' )}}</td>
                                            ...
                                            <td class="editc">
                                               <a href="{{ route('scp.invoice.json.download',$vl->scp_invoice_no)}}"><i class="fa fa-download" data-placement="top" title="Download" style="color:green"></i></a>
                                                ...
                                                <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('warehouseinvoice.delete',$vl->scp_invoice_no)}}" method="POST">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <button><i  data-placement="top" title="Delete" class="fa fa-trash" style="color:red"></i></button>
                                                </form>
                                                @else
                                                <a target="_blank" href="{{route('generate.scpinvoice.pdf',$vl->scp_invoice_no)}}"><i class="fa fa-eye" style="color:red"></i></a>
