    ...
    <div class="main-content page-content">
        ...
        <div class="main-content-inner">
            ...
            <div class="row" style="padding-bottom:50px">
                ...
                <div onClick="JavaScript:selectTab(5),sec('tab5Content')" class="col-xl-4 col-md-6 col-lg-12 stretched_card">

                    <div class="card mb-mob-4 icon_card info_card_bg">

                        <!-- Card body -->
                        <div class="card-body">
                            <p class="card-title mb-0 text-white">Total ASM</p>
                            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                                <h2 class="mb-0 text-white heart">{{$total_asm}}</h2>
                                <div class="arrow_icon"><i class="fa fa-rupee"></i></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="card-body">
                    <form method="post" action="{{route('regional.dashboard')}}">
                        @csrf
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="dts">
                                ...
                                <label onClick="JavaScript:selectTab(5);">ASM</label>
                                ...
                                <table class="table myTable" id="dataTable1" class="text-center boh">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="{{ route('amount.collect.master', $vl->partner_id) }}"><i  data-placement="top" title="View" class="fa fa-link" style="color:#056c91;margin: 10px;"></i></a>
                                            </td>
                                        </tr>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="dts">
                                ...
                                <label onClick="JavaScript:selectTab(3);">Sales</label>
                                <label onClick="JavaScript:selectTab(4);">Direct Partners</label>
                                <label onClick="JavaScript:selectTab(5);" class="dtslable">ASM</label>
                                ...
                                <table class="table myTable" id="dataTable4" class="text-center boh">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ASM-ID</th>
                                            <th>Name (ASM)</th>
                                            <th class="thdis">Email (ASM)</th>
                                            <th class="thdis">DOB (ASM)</th>
                                            <th>ID-Proof (ASM)</th>
                                            <th>Direct Partners (ASM)</th>
                                            <th>Address (ASM)</th>
                                            <th>Pincode (ASM)</th>
                                            <th>Phone (ASM)</th>
                                            <th class="thdis">City (ASM)</th>
                                            <th class="thdis">District (ASM)</th>
                                            <th class="thdis">State (ASM)</th>
                                            <th class="thdis">Country (ASM)</th>
                                            <th>status (ASM)</th>
                                            <th>date </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="thdis">{{$vl->email}}</td>
                                            <td class="thdis">{{$vl->dob}}</td>
                                            <td><a href="{{ asset('user/images/asm/'.$vl->proof) }}" target="_blank"><img style="width:30px;height:30px" src="{{ asset('user/images/file.png') }}"></a></td>

                                            <td>
                                                @foreach ($dis as $keys=>$vls)
                                                @php
                                                $data = DB::table('distributors')->where('partner_id',$vls->partner_id)->get();
                                                @endphp
                                                @if ($data->isEmpty())
                                                @php
                                                $dname='';
                                                ...
                                                @else
                                                @php
                                                $dname=$data[0]->name.' ('.$data[0]->partner_id.'),';
                                                @endphp
