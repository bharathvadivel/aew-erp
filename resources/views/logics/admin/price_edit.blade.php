            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Edit Price Details
                            ...
                            <hr>
                            <form method="post" action="{{route('price.update',$row->id)}}">
                                @csrf
                                <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="product_name" class="form-control">
                                                ...
                                                <option {{$row->product_name==$key->product_name ? 'selected':''}} value="{{ $key->product_name }}">{{ $key->product_name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="product_category" class="form-control">
                                                ...
                                                <option {{$row->product_category==$key->gategory_name ? 'selected':''}} value="{{ $key->gategory_name }}">{{ $key->gategory_name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$row->model_no}}"  type="text" name="model_no" class="form-control" placeholder="Model NO">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{$row->price}}" min="1" type="number" name="price" class="form-control" placeholder="Price">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Discount MRP</label>
                                            <input required="" value="{{$row->discount_mrp}}" type="number" min="1" name="discount_mrp" class="form-control" placeholder="Discount MRP">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="distributor" class="form-control">
                                                ...
                                                <option {{$row->distributor==$key->name ? 'selected':''}} value="{{ $key->name }}">{{ $key->name }}</option>
                                                @endforeach
                                ...
                                <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="dealor" class="form-control">
                                                ...
                                                <option {{$row->dealor==$key->name ? 'selected':''}} value="{{ $key->name }}">{{ $key->name }}</option>
                                                @endforeach
