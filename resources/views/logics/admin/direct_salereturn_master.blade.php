        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('direct.salereturn.master')}}">
                                @csrf
                                <div class="form-row">
                            ...
                            <h4 class="header-title">Manage Sale Return Invoice
                                <a href="{{ route('direct.salereturn') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i> Add Invoice</a>
                            </h4>
                            <br>
                            ...
                            <div class="table-responsive datatable-primary">
                                <table id="dataTable" class="text-center boh">
                                    ...
                                    <tbody>
                                        ...
                                        $dv = DB::table('warehouses')->where('warehouse_id',$vl->delivery_id)->first();
                                        $sn =DB::table('disserials')->where('salereturn_no',$vl->salereturn_no)->where('disinvoices_salereturn_id',$vl->id)->where('status','return')->pluck('serial_no')->toArray();
                                        ...
                                        @if(!$dv)
                                        @php
                                        $dv = DB::table('admins')->where('partner_id',$vl->delivery_id)->first();
                                        @endphp
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('direct.salereturn.print',$vl->salereturn_no)}}"><i  data-placement="top" title="Invoice" class="fa fa-eye" style="color:red"></i></a>

                                                @endif
                                                @if($vl->status=='Pending')
                                                <a href="{{route('direct.salereturn.edit',$vl->salereturn_no)}}"><i   data-placement="top" title="Edit" class="fa fa-edit" style="color:#056c91"></i></a>
                                                @if (session()->get('partner_type')=='admin')

                                                <a href="#"  data-bs-toggle="modal" data-bs-target="#exampleModal{{$vl->id}}"><i   data-placement="top" title="Status Change" class="fa fa-check" style="color:green"></i></a>
                                                @endif

                                                @endif

                                                @if($vl->status=='Pending')
                                                <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('direct.salereturn.delete',$vl->salereturn_no)}}" method="POST">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('direct.salereturn.status')}}">
                                                            @csrf
                                                            <div class="mb-3">
