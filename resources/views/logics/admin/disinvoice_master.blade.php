        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('disinvoice.master')}}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="partner_id" class="form-control">
                                                ...
                                                @foreach ($data as $key)
                                                <option {{$key->partner_id==$partner_id_value ? 'selected':''}} value="{{$key->partner_id}}">{{$key->store_name}}({{$key->partner_id}})</option>
                                                @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td class="editc">
                                               <a href="{{ route('disinvoice.json',$vl->disinvoice_no)}}">
                                                ...
                                                <a href="{{route('warehouseinvoice.edit',$vl->disinvoice_no)}}"><i  data-placement="top" title="Edit" class="fa fa-edit" style="color:#056c91"></i></a>
                                                <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('warehouseinvoice.delete',$vl->disinvoice_no)}}" method="POST">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <button><i  data-placement="top" title="Delete" class="fa fa-trash" style="color:red"></i></button>
                                                </form>
                                                @else
                                                <a target="_blank" href="{{url('generatepdf/'.$vl->disinvoice_no)}}"><i class="fa fa-eye" style="color:red"></i></a>
                                                <a href="{{route('disinvoice.edit',$vl->disinvoice_no)}}"><i  data-placement="top" title="Edit" class="fa fa-edit" style="color:#056c91"></i></a>
                                                <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('disinvoice.delete',$vl->disinvoice_no)}}" method="POST">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <button><i  data-placement="top" title="Delete" class="fa fa-trash" style="color:red"></i></button>
                                                </form>
