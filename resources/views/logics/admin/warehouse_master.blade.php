        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">warehouse
                                <a href="{{ route('warehouse') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i> Add warehouse</a>
                            </h4>
                            <br>
                                ...
                                <table id="dataTable2" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="editc"><a href="{{route('warehouse.edit',$vl->id)}}"><i  data-placement="top" title="Edit" class="fa fa-edit" style="color:#056c91"></i></a>

                                                <!-- <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('warehouse.delete',$vl->id)}}" method="POST">
