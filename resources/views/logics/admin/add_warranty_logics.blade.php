                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="model_no" class="form-control model_no @error('model_no') is-invalid @enderror">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('standard_warranty')}}" required="" name="standard_warranty" class="form-control @error('standard_warranty') is-invalid @enderror" placeholder="In years">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('extended_warranty')}}" required="" name="extended_warranty" class="form-control @error('extended_warranty') is-invalid @enderror" placeholder="In years">
                                ...
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="" value="{{old('part1')}}" name="part1" class="form-control @error('part1') is-invalid @enderror" placeholder="Part 1">
                                            @error('part1')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="" value="{{old('part1_warranty')}}" name="part1_warranty" class="form-control @error('part1_warranty') is-invalid @enderror" placeholder="In years">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="" value="{{old('part2')}}" name="part2" class="form-control @error('part2') is-invalid @enderror" placeholder="Part 2">
                                            @error('part2')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="" value="{{old('part2_warranty')}}" name="part2_warranty" class="form-control @error('part2_warranty') is-invalid @enderror" placeholder="In years">
