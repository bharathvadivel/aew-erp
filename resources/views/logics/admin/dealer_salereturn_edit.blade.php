...
<body onload="dis('{{$row->partner_id}}'),inv('{{$row->partnerinvoice_no}}',addr('{{$row->address}}'))">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="dis(this.value)" id="partner_name" name="partner_id" class="form-control">
                                                <option selected value="{{$row->partner_id}}"> @if($temp) {{$temp->store_name}} @endif {{ '('.$row->partner_id.')'}})</option>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select onchange="inv(this.value)" id="partnerinvoice_no" name="partnerinvoice_no" class="form-control partnerinvoice_no">
                                                <option selected value="{{$row->partnerinvoice_no}}">{{$row->partnerinvoice_no}}</option>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped text-center invoice">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                            $count = DB::table('distributorserials')->where('partnerinvoices_salereturn_id','=',$da->id)->where('status','return')->count();
                                            @endphp
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><a href="{{route('dealer.salereturn.master')}}"><button class="btn btn-danger">Complete Invoice</button></a></td>
        ...
        function cat(gategory_id) {
            ...
            $.ajax({
                ...
                , success: function(data) {
                    ...
                    var ser = "<div class='form-group'><label for='disabledSelect'>Serial No <span style='color:red'>&#9733;</span></label> <select name='serial_no[]' class='form-control'> <
                    option value = '' > Select < /option> < /
                        select > </div >
                    ";
                    $('.serial_no').html(ser);
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('dealer.salereturn.update') }}",
