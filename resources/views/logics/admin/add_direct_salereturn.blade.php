                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="dis(this.value),adm(this.value)" id="dis_name" name="dis_id" class="form-control">
        ...
        function adm(inid) {
            ...
            if (inid == '') {
                swal({
                    type: "error"
                    , title: "Warning!"
                    , text: "Please Select Direct Partner!"
                    , confirmButtonText: "Ok"
                    , buttonsStyling: !1
                    , confirmButtonClass: "btn btn-danger"
                });
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('return.disinvoice.store') }}",
