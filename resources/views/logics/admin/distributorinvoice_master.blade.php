        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('distributorinvoice.master')}}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Dealer</label>
                                            <select name="partner_id" class="form-control">
                                                <option value="all">All</option>

                                                @foreach ($data as $key)
                                                <option {{$key->partner_id==$partner_id_value ? 'selected':''}} value="{{$key->partner_id}}">{{$key->name}}({{$key->partner_id}})</option>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="partnerinvoice_no" class="form-control">


                                                <option value="all">All</option>

                                                @foreach ($list as $key)
                                                <option {{$key->partnerinvoice_no==$partnerinvoice_no ? 'selected':''}} value="{{$key->partnerinvoice_no}}">{{$key->partnerinvoice_no}}</option>
                                                @endforeach
                            ...
                            <h4 class="header-title">Manage Invoice
                                <a href="{{ route('distributorinvoice') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i> Add Invoice</a>
                            </h4>
                            <br>
