...
<body>
                ...
                @if (count($errors) < 1 ) @if (!Session::get('warning')) @php $array=session()->forget('location');
                    ...
                    <div class="col-12 mt-4" style="margin-top:0!important;">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    <h5 class="card_title " style="color:#50aaca"> Add Direct Partners
                                        <a href="{{ route('distributor.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage Direct Partners</a>
                                    </h5>
                                ...
                                <form method="post" action="{{route('distributor.store')}}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                <label for="disabledSelect">Partner type <span style="color:red">&#9733;</span></label>
                                                <select onchange="partnerType(this.value)" required="" name="partner_type" class="form-control @error('partner_type') is-invalid @enderror">
                                                    <option value="">Select</option>
                                                    <option {{old('partner_type')=='distributor' ? 'selected':''}} value="distributor">Distributor</option>
                                                    <option {{old('partner_type')=='direct_dealer' ? 'selected':''}} value="direct_dealer">Direct dealer</option>
                                                </select>
                                                @error('partner_type')
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                <label for="disabledTextInput">Partner ID<span style="color:red">&#9733;</span></label>
                                                <input readonly id="partner_ids" value="{{old('partner_id')}}" type="text" name="partner_id" class="form-control @error('partner_id') is-invalid @enderror" placeholder="Partner ID">
                                                @error('partner_id')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                <label for="disabledTextInput">Company/Store name <span style="color:red">&#9733;</span></label>
                                                <input type="text" required="" value="{{old('store_name')}}" name="store_name" class="form-control @error('store_name') is-invalid @enderror" placeholder="Company/Store name">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{old('name')}}" name="name" required="" class="form-control  @error('name') is-invalid @enderror" placeholder="Owner Name">
                                                @error('name')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input required="" value="{{old('email')}}" type="email" name="email" class="form-control  @error('email') is-invalid @enderror" placeholder="Email">
                                                @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input required="" value="{{old('dob')}}" type="date" name="dob" class="form-control  @error('dob') is-invalid @enderror" placeholder="Dob">
                                                @error('dob')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input minlength="15" value="{{old('gstin_no')}}" maxlength="15" type="text" name="gstin_no" class="form-control @error('gstin_no') is-invalid @enderror" placeholder="GSTIN-NO">
                                                @error('gstin_no')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input required="" value="{{old('phone')}}" type="text" onkeypress="return /[0-9]/i.test(event.key)" minlength="10" maxlength="10" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone">
                                                @error('phone')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input required="" value="{{old('credit_limit')}}" type="text" name="credit_limit" class="form-control @error('credit_limit') is-invalid @enderror" placeholder="Credit Limit">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input required="" value="{{old('credit_days')}}" type="text" name="credit_days" class="form-control @error('credit_days') is-invalid @enderror" placeholder="Credit Days">
                                                @error('credit_days')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <input type="hidden" value="{{ $created_id }}" name="created_id">
    ...
    <script>
        function partnerType(partner_type) {
            if (partner_type == '') {
                swal({
                    type: "error"
                    , title: "Warning!"
                    , text: "Please Select Direct Partners!"
            ...
            $.ajax({
                ...
                , success: function(data) {
                    $('#partner_ids').val(data);
                }
                , error: function(data) {
                    swal({
                        type: "error"
                        , title: "Error!"
                        , text: "get partner id failed !"
