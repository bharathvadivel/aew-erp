    ...
    <div class="main-content page-content">
        ...
        <div class="main-content-inner">
            ...
            <div class="row" style="padding-bottom:50px">
                ...
                <div onclick="window.location.href ='{{route('enquiry.manage')}}'" class="col-xl-4 col-md-6 col-lg-12 stretched_card">
                ...
                <div onClick="JavaScript:selectTab(3),sec('tab3Content')" class="col-xl-4 col-md-6 col-lg-12 stretched_card">
                    ...
                    <div class="card mb-mob-4 icon_card success_card_bg">
                        <!-- Card body -->
                        <div class="card-body">
                            <p class="card-title mb-0 text-white">Over all Complete Enquiries</p>
                            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
            ...
            <div class="row">
                ...
                <div onclick="window.location.href ='{{route('executive.master')}}'" class="col-xl-4 col-md-6 col-lg-12 stretched_card">
                    <div class="card mb-mob-4 icon_card info_card_bg">
                        <!-- Card body -->
                        <div class="card-body">
                            <p class="card-title mb-0 text-white">Total Executives</p>
                            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="dts">
                                ...
                                <label onClick="JavaScript:selectTab(3);">Over all Completed Calls</label>
                                <label onClick="JavaScript:selectTab(4);">Part Return Calls</label>
                            </div>
                            ...
                            <div class="table-responsive datatable-primary">
                                <table class="table myTable" id="dataTable" class="text-center boh">
                                    ...
                                    <tbody>
                                        ...
                                        $alert='alert alert-success';
                                        @endphp
                                        @elseif($key->status=='Transfer request')
                                        @php $status='Transfer request';
                                        $color='#2fe65e';
                                        $alert='alert alert-success';
                                        @endphp
                                        @elseif($key->status=='Transfered')
                                        @php $status='Transfered';
                                        $color='#2fe65e';
                                        $alert='alert alert-success';
                                        @endphp
                                        @else
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="dts">
                                <label onClick="JavaScript:selectTab(1);">Today Call Details</label>
                                <label onClick="JavaScript:selectTab(2);">Over all Pending Calls</label>
                                <label onClick="JavaScript:selectTab(3);" class="dtslable">Over all Completed Calls</label>
                                <label onClick="JavaScript:selectTab(4);">Part Return Calls</label>
                            </div>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="dts">
                                ...
                                <label onClick="JavaScript:selectTab(2);">Over all Pending Calls</label>
                                <label onClick="JavaScript:selectTab(3);">Over all Completed Calls</label>
                                <label onClick="JavaScript:selectTab(4);" class="dtslable">Part Return Calls</label>
                            </div>
                            <div class="table-responsive datatable-primary">
