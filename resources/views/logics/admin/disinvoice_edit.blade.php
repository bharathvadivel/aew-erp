                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('disinvoice.csv.store.update')}}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="{{$row->disinvoice_no}}" type="text" name="disinvoice_no" class="form-control" placeholder="Invoice no">
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <div class="form-group">
                                            ...
                                            <select required="" id="dis_id" name="dis_id" class="form-control ">
                                                <option value="">Select</option>
                                                <option {{ $partner? 'selected':''}} value="{{ $partner ? $partner->partner_id:'' }}">{{ $partner ? $partner->store_name:'' }}({{$partner ? $partner->partner_id:''}})</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped text-center invoice">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                            $count = DB::table('disserials')->where('disinvoices_id','=',$da->id)->count();
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><a href="{{route('disinvoice.master')}}"><button class="btn btn-danger">Complete Invoice</button></a></td>
...
*===========================-->
    ...
    <script>
        function remove(id, disinvoice_no) {
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            if (serial_no.length <= 0 || delivery_location_id == '' || disinvoice_no == '' || dis_id == '' || partner_type == '' || location_id == '' || gategory_id == '' || price == '' || billing_price == '' || basic_allowance == '' || sta == '' || partner_allowance == '' || additional_discount == '' || created_by == '' || model_no == '' || login_id == '') {
                swal({
                    type: "error"
                    , title: "Error!"
