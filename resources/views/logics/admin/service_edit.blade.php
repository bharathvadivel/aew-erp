            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Edit Service Center
                            ...
                            <form method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="{{$row->service_id}}" type="text" name="service_id" class="form-control" placeholder="Service ID">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{$row->service_center_name}}" type="text" name="service_center_name" class="form-control" placeholder="Service center name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{$row->name}}" type="text" name="name" class="form-control" placeholder="Owner Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input required="" type="email" value="{{$row->email}}" name="email" class="form-control" placeholder="Email">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Phone <span style="color:red">&#9733;</span></label>
                                            <input required="" value="{{$row->phone}}" onkeypress="return /[0-9]/i.test(event.key)" minlength="10" maxlength="10" type="text" name="phone" class="form-control" placeholder="Phone">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$row->gstin_no}}" minlength="15" maxlength="15" name="gstin_no" class="form-control" placeholder="GSTIN-NO">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-12">
                                        <div class="form-group">
                                            ...
                                            <select id="choices-multiple-remove-button" placeholder="Select category" multiple required="" name="gategory_id[]" class="form-control gategory_id">
                                                ...
                                                <option {{ (in_array($vl->id,$ch_array)) ? 'selected' : '' }} value="@php echo $vl->id @endphp">@php echo $vl->gategory_name @endphp </option>;
                                                @endforeach
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$service_pincode}}" required="" pattern="[^a-zA-Z]+" type="text" name="service_pincode" class="form-control" placeholder="Pincode">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input id="map-search" required="" value="{{$row->address}}" type="text" name="address" class="form-control" placeholder="Address">
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Pincode <span style="color:red">&#9733;</span></label>
                                            <input required="" oninput="new_location(this.value)" onkeypress="return /[0-9]/i.test(event.key)" minlength="6" maxlength="6" value="{{$row->pincode}}" type="text" name="pincode" class="form-control" placeholder="Pincode">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$row->city}}" readonly required="" placeholder="City" name="city" class="form-control new_city">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly value="{{$row->district}}" required="" name="district" class="form-control new_district" placeholder="District">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$row->state}}" readonly required="" name="state" class="form-control new_state" placeholder="State">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" readonly value="{{$row->country}}" type="text" name="country" class="form-control new_country" placeholder="Country">
                                        </div>
                                    </div>
                                ...
                                <center><button type="submit" class="btn btn-primary mt-4 pl-4 pr-4 btn-submit">Submit</button>
                                </center>
                                <div class="form-row">
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('service.update',$row->id) }}",
    ...
    <script>
        function initialize() {
            ...
            mapOptions = {
                ...
                center: new google.maps.LatLng({{$row->lat}}, {{$row->lang}}),
                // center : {
                // 	lat: -34.397,
                // 	lng: 150.644
                // },
