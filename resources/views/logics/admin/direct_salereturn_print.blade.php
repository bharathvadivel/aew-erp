                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="invoice-title-edit">
                                                        ...
                                                        <h4 style="font-size: 16px;" class="font-16 pull-right"><strong>Sale Return Invoice No:{{$disinvoices[0]->salereturn_no}}</strong></h4>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                ...
                                                                $from= DB::table('distributors')->where('partner_id',$dis_id)->first();
                                                                @endphp
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{$disinvoices[0]->address}}</span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            <address class="ship">
                                                                @php
                                                                $delivery_id=$disinvoices[0]->delivery_id;
                                                                $delivery = DB::table('admins')->where('partner_id',$delivery_id)->first();
                                                                @endphp
                                                                @if ($delivery)
                                                                @php
                                                                $delivery = DB::table('admins')->where('partner_id',$delivery_id)->first();
                                                                ...
                                                                @else
                                                                @php
                                                                $delivery = DB::table('warehouses')->where('warehouse_id',$delivery_id)->first();
                                                                @endphp
                                                                @endif
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{$disinvoices[0]->delivery_address}}</span>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-12 col-xs-12 m-t-30 text-center">
                                                            <address>
                                                                ...
                                                                $date=$disinvoices[0]->date!='' ? date('Y-m-d',strtotime($disinvoices[0]->date)):$date='---';
                                                            ...
                                                            <div class="panel panel-default">
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table border="1" class="table borderclr table-bordered">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                $s_list=DB::table('disserials')->where('salereturn_no',$disinvoices[0]->salereturn_no)->where('disinvoices_salereturn_id',$vl->id)->where('status','return')->pluck('serial_no')->toArray();
                                                                               ...
                                                                               <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="text-right">{{number_format($disinvoices[0]->grand_total,2)}}</th>
                                                                                                                                   ...
                                                                                                                                   <tr>
                                                                                <th colspan="12" style="text-transform: uppercase;word-break: break-all;">Amount in words : {{App\Http\Controllers\AdminController::words($disinvoices[0]->grand_total)}}</th>
                                                                ...
                                                                <div class="d-print-none">
                                                                    <div class="pull-right">
                                                                        <a href="{{url('direct_salereturn_stream_pdf/'.$disinvoices[0]->salereturn_no)}}" target="_blank" class="btn btn-success waves-effect waves-light "></i>Print</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
