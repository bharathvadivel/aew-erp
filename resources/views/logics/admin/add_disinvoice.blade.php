                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="directPartner(this.value)" id="dis_id" name="dis_id" class="form-control selectsearch">
                                                <option value="">Select</option>

                                                @foreach ($partner as $key)

                                                <option value="{{ $key->partner_id }}">{{ $key->store_name }}({{$key->partner_id}})</option>
                                                @endforeach
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" readonly type="text" class="form-control credit_days" placeholder="Days">
                                        </div>
                                    </div>
...
*===========================-->
    ...
    <script>
        function getinvoiceno(partner_id) {
            ...
            $.ajax({
                ...
                , error: function(data) {
                    swal({
                        type: "error"
                        , title: "Error!"
                        , text: "please check Direct partner !"
                        , confirmButtonText: "Dismiss"
                        , buttonsStyling: !1
                        , confirmButtonClass: "btn btn-danger"
                    });
