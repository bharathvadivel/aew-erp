...
<body onload="part_type({{$row->partner_type}})">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Edit Direct Partner
                                    <a href="{{ route('distributor.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage Direct Partner</a>
                                </h5>
                            ...
                            <hr>
                            <form method="post" action="{{route('distributor.update',$row->id)}}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="{{ $row->partner_type }}" required="" name="partner_type" class="form-control @error('partner_type') is-invalid @enderror">
                                    ...
                                    <div class="col-md-2 mb-2" id="db">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Distributor-ID <span style="color:red">&#9733;</span></label>
                                            <input readonly id="ddid" value="{{$row->partner_id}}" type="text" name="partner_id" class="form-control @error('partner_id') is-invalid @enderror" placeholder="Distributor ID">
                                            @error('partner_id')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-2 mb-2" id="dd" hidden>
                                        <div class="form-group">
                                            <label for="disabledTextInput">Direct Dealer-ID <span style="color:red">&#9733;</span></label>
                                            <input readonly disabled id="deid" value="{{$row->partner_id}}" type="text" name="partner_id" class="form-control @error('partner_id') is-invalid @enderror" placeholder="Dealer ID">
                                            @error('partner_id')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="" value="{{$row->store_name}}" name="store_name" class="form-control @error('store_name') is-invalid @enderror" placeholder="Company/Store name">
                                            @error('store_name')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$row->name}}" required="" type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Owner name">
                                            @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$row->email}}" required="" type="email" name="email" class="form-control  @error('email') is-invalid @enderror" placeholder="Email">
                                            @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{$row->phone}}" type="text" onkeypress="return /[0-9]/i.test(event.key)" minlength="10" maxlength="10" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone">
                                            @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{$row->credit_days}}" type="text" name="credit_days" class="form-control @error('credit_days') is-invalid @enderror" placeholder="Credit Days">
                                            @error('credit_days')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <input type="hidden" value="{{$row->created_id}}" name="created_id">
