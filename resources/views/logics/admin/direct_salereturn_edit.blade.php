...
<body onload="dis('{{$row->dis_id}}'),inv('{{$row->disinvoice_no}}',addr('{{$row->address}}'))">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Edit Sale Return Invoice
                                    <a href="{{ route('direct.salereturn.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage invoice </a>
                                </h5>
                            ...
                            <form>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="{{$row->salereturn_no}}" type="text" name="salereturn_no" class="form-control" placeholder="Invoice no">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="dis(this.value)" id="dis_name" name="dis_id" class="form-control">
                                                <option selected value="{{$row->dis_id}}"> @if($temp) {{$temp->store_name}} @endif {{ '('.$row->dis_id.')'}}</option>
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="hidden" value="{{$row->partner_type}}" name="partner_type" class="form-control partner_type">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-6">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="addr(this.value)" name="address" class="form-control address">
                                                @foreach ($loc as $set)
                                                <option {{$set->location_id==$row->location_id ? 'selected':''}} value="{{$set->address}}">{{$set->address}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" readonly value="{{$row->state}}" name="state" class="form-control states" placeholder="State"></input>
                                    <input type="hidden" readonly value="{{$row->country}}" name="country" class="form-control countrys" placeholder="Country"></input>
                                    <input type="hidden" readonly value="{{$row->pincode}}" name="pincode" class="form-control pincode" placeholder="Pincode"></input>
                                    <input type="hidden" readonly value="{{$row->location_id}}" name="location_id" class="form-control location_id" placeholder="Location id"></input>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select onchange="inv(this.value)" id="disinvoice_no" name="disinvoice_no" class="form-control disinvoice_no">
                                                <option selected value="{{$row->disinvoice_no}}">{{$row->disinvoice_no}}</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="0" readonly type="number" min="0" name="partner_allowance" class="form-control partner_allowance" placeholder="Direct Partner Allowance">
                                            <span style="font-size:12px;color:red">Note: Enter Percentage Value</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="0" readonly min="0" type="number" name="additional_discount" class="form-control additional_discount" placeholder="Addtional Discount">
                                            <span style="font-size:12px;color:red">Note: Enter Amount Value</span>
                                ...
                                <input type="hidden" id="txt" value="{{$row->dis_name}}" name="dis_name">

                                <input type="hidden" value="{{$row->created_by}}" name="created_by">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped text-center invoice">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                            $count = DB::table('disserials')->where('disinvoices_salereturn_id','=',$da->id)->where('status','return')->count();
                                            @endphp
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><a href="{{route('direct.salereturn.master')}}"><button class="btn btn-danger">Complete Invoice</button></a></td>
...
*===========================-->
    ...
    <script>
        function remove(id) {
            ...
            $.ajax({
                type: 'POST'
                , url: "{{ route('direct.salereturn.remove')}}"
                , data: {
                    id: id
                , }
    ...
    <script>
        function inv(disinvoice_no) {
            ...
            // event.preventDefault();
            var disinvoice_no = disinvoice_no;
            $.ajax({
                type: 'POST'
                , url: "{{ route('disinvoice_no.select')}}"
                , data: {
                    dis_id: dis_id
    ...
    <script>
        function cat(gategory_id) {
            var disinvoice_no = document.getElementById("disinvoice_no").value;
            ...
            $.ajax({
                type: 'POST'
                , url: "{{ route('disinvoice_no.model.select')}}"
                , data: {
    ...
    <script>
        function product(description) {
            ...
            $.ajax({
                type: 'POST'
                , url: "{{ route('direct.product.select')}}"
                , data: {
                ...
                , success: function(data) {
                    ...
                    $('.partner_allowance').val(val.partner_allowance);
                    $('.additional_discount').val(val.additional_discount);
                    $('.total').val(val.total);
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            var disinvoice_no = $("select[name=disinvoice_no]").val();
            ...
            var model_no = $("select[name=model_no]").val();
            if (serial_no.length <= 0 || address == '' || salereturn_no == '' || disinvoice_no == '' || dis_name == '' || dis_id == '' || phone == '' || credit_limit == '' || credit_days == '' || partner_type == '' || pincode == '' || city == '' || district == '' || state == '' || country == '' || location_id == '' || gategory_id == '' || description == '' || price == '' || billing_price == '' || basic_allowance == '' || sta == '' || partner_allowance == '' || additional_discount == '' || created_by == '' || delivery_id == '' || available_limit == '' || total == '' || delivery_address == '' || delivery_location_id == '' || model_no == '') {
            ...
            $.ajax({
                ...
                url: "{{ route('direct.salereturn.update') }}",
