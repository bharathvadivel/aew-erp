        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card_title " style="color:#50aaca"> Add Service Center Invoice
                                <a href="{{ route('scpinvoice.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage invoice </a>
                            </h5>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('scpinvoice.csv.store')}}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input readonly id="inid" value="{{$scp_invoice_no}}" type="text" name="scp_invoice_no" class="form-control" placeholder="Invoice no">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="getinvoiceno(this.value)" id="warehouse_id" name="created_by" class="form-control selectsearch">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledSelect">Service Partner <span style="color:red">&#9733;</span></label>
                                            <select required="" onchange="servicePartner(this.value)" id="scp_id" name="scp_id" class="form-control selectsearch">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" minlength="10" maxlength="10" readonly type="text" class="form-control phone" placeholder="Mobile Number">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <!-- <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label style="white-space:nowrap" for="disabledTextInput">Credit Days</label>
                                            <input readonly type="text" class="form-control credit_days" placeholder="Days">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" readonly type="text" class="form-control credit_limit" placeholder="Credit Limit">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" readonly type="text" class="form-control available_limit" placeholder="Available Limit">
                                        </div>
                                    </div> -->
                                ...
                                <div class="form-row" style="display:none;" id="deliveryaddress">
                                    <div class="col-md-6 mb-6">
                                        <div class="form-group">
                                            ...
                                            <select onchange="newDeliveryAddress(this.value)" name="delivery_location_id" class="form-control deliveryaddress selectsearch" style="width: 590px">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" class="form-control description" placeholder="Description">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input readonly value="0" type="number" id="total_qty" name="total_qty" class="form-control" placeholder="Addtional Discount">
                                                <span style="font-size:12px;color:red">Note: No of Selected Serials</span>
                                            </div>
                                        </div>
                                ...
                                <div id="entrysubmit" style="display:none">
                                    <center>
                                        <button id="ajaxsubmit" class="btn btn-primary mt-4 pl-4 pr-4 btn-submit">Submit</button>
                                    </center>
...
*===========================-->
    ...
    <script>
        function getinvoiceno(service_id) {
    ...
    <script>
        function servicePartner(scp_id) {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('service.partner.details')}}",
                data: {
                    scp_id: scp_id
                },
                success: function(data) {
                ...
                error: function(data) {
                    swal({
                        type: "error",
                        title: "Error!",
                        text: "please check Service Partner!",
                        confirmButtonText: "Dismiss",
                        buttonsStyling: !1,
                        confirmButtonClass: "btn btn-danger"
                    });
    ...
    <script>
        function model(model_no) {
            var scp_id = document.getElementById("scp_id").value;
            var warehouse_id = document.getElementById("warehouse_id").value;

            if (scp_id == '') {
                alert('Please Choose Service Partner');
                return false;
            }
            if (warehouse_id == '') {
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            var scp_id = $("select[name=scp_id]").val();
            ...
            var scp_invoice_type = "Stock Transfer";
            var login_id = $("input[name=login_id]").val();
            var login_id = $("input[name=login_id]").val();
            ...
            console.log("Serial No Length: "+ serial_no.length);
            console.log("Delivery Location ID: "+ delivery_location_id);
            console.log("SCP Invoice No: "+ scp_invoice_no);
            console.log("SCP ID: "+ scp_id);
            console.log("Partner Type: "+ partner_type);
            console.log("Location ID: "+ location_id);
            console.log("Gategory ID: "+ gategory_id);
            console.log("Price: "+ price);
            console.log("Billing Price: "+ billing_price);
            console.log("Additional Discount: "+ additional_discount);
            console.log("Created By: "+ created_by);
            console.log("Model No: "+ model_no);
            console.log("Login ID: "+ login_id);

            if (serial_no.length <= 0 || delivery_location_id == '' || scp_invoice_no == '' || scp_id == '' || partner_type == '' || location_id == '' || gategory_id == '' || price == '' || billing_price == '' || additional_discount == '' || created_by == '' || model_no == '' || login_id == '') {
                swal({
                    type: "error",
                    title: "Error!",
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('scpinvoice.store') }}",
                data: {
                    scp_invoice_no: scp_invoice_no,
                    scp_id: scp_id,
                    scp_invoice_type: scp_invoice_type,
