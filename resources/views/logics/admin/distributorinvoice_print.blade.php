                ...
                <div class="content">
                    ...
                    <div class="page-content-wrapper">
                        <div class="container-fluid">
                            <div class="row">
                                <div style="margin:101px 0px 0px 0px " class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="invoice-title-edit">
                                                        ...
                                                        <h4 style="font-size: 16px;" class="pull-right font-16"><strong>Invoice No:{{$distributorinvoices[0]->partnerinvoice_no}}</strong></h4>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                @php
                                                                $partner_id=$distributorinvoices[0]->created_by;
                                                                $from_location_id=$distributorinvoices[0]->from_location_id;
                                                                $from = DB::table('distributors')->where('partner_id',$partner_id)->first();
                                                                $from_location = DB::table('userlocations')->where('partner_id',$partner_id)->where('location_id',$from_location_id)->first();
                                                                @endphp
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{$from_location->address}}</span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                @php
                                                                $partner_id=$distributorinvoices[0]->partner_id;
                                                                $sub_location_id=$distributorinvoices[0]->sub_location_id;
                                                                $billto = DB::table('distributors')->where('partner_id',$partner_id)->first();
                                                                $billto_location = DB::table('userlocations')->where('partner_id',$partner_id)->where('location_id',$sub_location_id)->first();
                                                                @endphp

                                                                <strong>Billed To:</strong><br>
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add">{{$billto->store_name}}</span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{ $billto->phone }}</span>
                                                                </div>

                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{$billto_location->address}}</span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="ship">
                                                                @php
                                                                $partner_id=$distributorinvoices[0]->partner_id;
                                                                $delivery_location_id=$distributorinvoices[0]->delivery_location_id;
                                                                $shipped= DB::table('distributors')->where('partner_id',$partner_id)->first();
                                                                $shipped_location = DB::table('userlocations')->where('partner_id',$partner_id)->where('location_id',$delivery_location_id)->first();
                                                                @endphp
                                                                <strong>Shipped To:</strong><br>
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add">{{$shipped->store_name}}</span>
                                                                </div>

                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{ $shipped->phone }}</span>
                                                                </div>


                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{$shipped_location->address}}</span>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-12 col-xs-12 m-t-30 text-center">
                                                            <address>
                                                                ...
                                                                @php
                                                                $by_order_no=$distributorinvoices[0]->by_order_no!='' ?$distributorinvoices[0]->by_order_no :$by_order_no='---';
                                                                $date=$distributorinvoices[0]->date!='' ? date('Y-m-d',strtotime($distributorinvoices[0]->date)):$date='---';
                                                                $ew_bill_no=$distributorinvoices[0]->ew_bill_no!='' ? $distributorinvoices[0]->ew_bill_no:$ew_bill_no='---';
                                                                $others=$distributorinvoices[0]->others!='' ? $distributorinvoices[0]->others:$others='---';
                                                                @endphp
                                                            ...
                                                            <div class="panel panel-default">
                                                                        ...
                                                                        <table border="1" class="table borderclr table-bordered">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    @if($distributorinvoices[0]->state=='TAMILNADU' )
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                $s_list=DB::table('distributorserials')->where('partnerinvoices_id',$vl->id)->pluck('serial_no')->toArray();
                                                                                ...
                                                                                @endforeach
                                                                                @if ($distributorinvoices[0]->tcs!=0)
                                                                                @php
                                                                                $set_total=($sub_total/100)*$distributorinvoices[0]->tcs;
                                                                                $net_total=$pay+$set_total;
                                                                                $set_tcs=$distributorinvoices[0]->tcs;;
                                                                                @endphp
                                                                                @else
                                                                                @php
                                                                                $set_total=0;
                                                                                ...
                                                                                <tr>
                                                                                    <td rowspan="2" colspan="8">Declaration: We declare that this invoice shows the actual price of the goods described
                                                                                        ...
                                                                                        per Month. I/We unconditionally agree to pay for the invoice in the above terms.</td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="text-right">{{number_format($distributorinvoices[0]->round_off,2)}}</th>

                                                                                </tr>
                                                                                <tr>
                                                                                    <th rowspan="1" colspan="5">For Yara Electronics Pvt Ltd</th>
                                                                                    <td colspan="3">Authorised Signatory</td>

                                                                                    <th colspan="2" class="text-right">Net Total</th>
                                                                                    <th class="text-right">{{number_format($distributorinvoices[0]->grand_total,2)}}</th>
                                                                                </tr>

                                                                                <tr>
                                                                                    <th colspan="12" style="text-transform: uppercase;word-break: break-all;">Amount in words : {{App\Http\Controllers\AdminController::words($distributorinvoices[0]->grand_total)}}</th>
                                                                ...
                                                                <div class="d-print-none">
                                                                    <div class="pull-right">
                                                                        <a href="{{url('invoice_pdf/'.$distributorinvoices[0]->partnerinvoice_no)}}" target="_blank" class="btn btn-success waves-effect waves-light "></i>Print</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
