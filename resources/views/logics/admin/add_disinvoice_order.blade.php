...
<body onload="warehouse('{{ $login_id }}')">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('disinvoice.csv.store')}}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="{{$disinvoice_no}}" type="text" name="disinvoice_no" class="form-control" placeholder="Invoice no">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="warehouse(this.value)" id="warehouse_id" name="created_by" class="form-control">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="dis(this.value)" id="dis_name" name="dis_id" class="form-control">
                                                ...
                                                <option value="{{ $key->partner_id }}" data-id="{{ $key->name }}">{{ $key->name }}({{$key->partner_id}})</option>
                                                @endforeach
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-6">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Billing Address &nbsp;&nbsp;&nbsp; <input id="same" name="ch_box_status" value="ch_ked" checked type="checkbox">&nbsp;Same as delivery address<span style="color:red">&#9733;</span></label>
                                    ...
                                    <input type="hidden" id="txt" name="dis_name">

                                    <input type="hidden" value="{{$login_id}}" name="login_id">
                                    <input type="hidden" name="from_location_id" class="from_location_id">
                                    <input type="hidden" name="from_address" class="from_address">
                                </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <select onchange="cat(this.value)" name="gategory" class="form-control v1">
                                                    <option value="">Select</option>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <select onchange="cod(this.value)" name="model_no" class="form-control model_no v7">
                                                    <option value="">Select</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input readonly value="0" type="number" name="sta" class="form-control sta v8" placeholder="STA">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input value="0" type="number" min="0" name="partner_allowance" class="form-control v10" placeholder="Direct Partner Allowance">
                                                <span style="font-size:12px;color:red">Note: Enter Percentage Value</span>
                                            </div>
                                        </div>
                                ...
                                <div id="entrysubmit" style="display:none">
                                    <center><button type="button" class="btn btn-primary mt-4 pl-4 pr-4 btn-submit">Submit</button>
                                    </center>
                                </div>
...
*===========================-->
    ...
    <script>
        function warehouse(warehouse_id) {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                type: 'POST'
                , url: "{{ route('warehouse_select')}}"
                , data: {
                    warehouse_id: warehouse_id
                }
                , success: function(data) {
                    var val = JSON.parse(data);
                    $('.from_location_id').val(val.from_location_id);
                    $('.from_address').val(val.from_address);
    ...
    <script>
        function product(description) {
            var dis = document.getElementById("dis_name").value;
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            var gategory = $("select[name=gategory]").val();
            ...
            var from_location_id = $("input[name=from_location_id]").val();
            ...
            if (same) {
                ...
                var delivery_location_id = $("input[name=location_id]").val();
