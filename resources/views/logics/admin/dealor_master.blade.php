                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Dealer
                                                 @if (session()->get('partner_type')!='Accounts')

                                                <a href="{{ route('dealor') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i> Add dealer</a>
@endif
                                            </h4>
                                            <br>
                                                ...
                                                <table id="dataTable2" class="display" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="{{route('dealor.edit',$vl->id)}}"><i  data-placement="top" title="Edit" class="fa fa-edit" style="color:#056c91"></i></a>
                                                                @if (session()->get('partner_type')=='admin')

                                                                {{-- <form onsubmit="return confirm('Are you sure you want to delete?');" action="{{ route('dealor.delete',$vl->id)}}" method="POST">
                                        ...
                                        $(document).ready(function() {
                                            $('#dataTable2').DataTable( {
                                             ...
                                             orientation:'landscape',
                                                    exportOptions: {
                                                        columns: [ 0, 1, 2,5,7,8,9,14,15,16]
                                                    }
                                                },
                                                  {
                                                    extend: 'print',
