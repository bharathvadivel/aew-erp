            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h5 class="card_title " style="color:#50aaca"> Add Brand Promoter
                                    <a href="{{ route('promoter.master') }}" class="btn btn-primary btns"> <i class="fa fa-plus-circle"></i>Manage Brand Promoter</a>
                                </h5>
                            </center>
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('promoter.store')}}">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Promoter-ID <span style="color:red">&#9733;</span></label>
                                            <input readonly value="{{$promoter_id}}" type="text" name="promoter_id" class="form-control @error('promoter_id') is-invalid @enderror" placeholder="Promoter ID">
                                            @error('promoter_id')
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" type="file" name="proof" class="form-control  @error('proof') is-invalid @enderror">
                                            @error('proof')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="dealor_id" class="form-control @error('dealor_id') is-invalid @enderror">
                                                ...
                                                <option {{$key->partner_id==old('dealor_id') ? 'selected':''}} value="{{ $key->partner_id }}">{{ $key->store_name }} ({{ $key->partner_id }})</option>
                                                @endforeach
                                            </select>
                                            @error('dealor_id')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('address')}}" type="text" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Address">
                                            @error('address')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('pin_code')}}" oninput="new_location(this.value)" type="text" onkeypress="return /[0-9]/i.test(event.key)" minlength="6" maxlength="6" name="pin_code" class="form-control @error('pin_code') is-invalid @enderror" placeholder="Pincode">
                                            @error('pin_code')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input required="" value="{{old('phone')}}" onkeypress="return /[0-9]/i.test(event.key)" minlength="10" maxlength="10" type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone">
                                            @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
