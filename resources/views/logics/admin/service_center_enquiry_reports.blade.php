...
<body>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" required="" name="from_date" id="from_date" value="{{$from_date}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" required="" name="to_date" id="to_date" value="{{$to_date}}" class="form-control">
                                        </div>
                                    </div>

                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="disabledTextInput">Executive<span style="color:red">&#9733;</span></label>
                                            <select id="executive_id" required="" class="form-control" name="executive_id">
                                                <option value="All">All executives</option>
                                                @foreach ($executive as $key)
                                                <option {{$key->executive_id==$executive_id ? 'selected':''}} value="{{$key->executive_id}}">{{$key->name}}</option>
                                                    ...
                                                    <div class="modal-content model_color">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-3">{{$vl->date_of_purchase}}</div>
    ...
    <script>
        function excelDownload() {
            ...
            if (status == '' || from_date == '' || to_date == '' || executive_id == '') {
                alert('Please fill all search fields');
                return false;
            }
            var url = "{{ route('service.center.calls.export')}}?" + 'from_date=' + from_date + '&to_date=' + to_date + '&executive_id=' + executive_id + '&status=' + status;
