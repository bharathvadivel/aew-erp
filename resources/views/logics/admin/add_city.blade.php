        ...
        <div class="main-content-inner">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            <center><h5 class="card_title " style="color:#50aaca"> Add city name
                            <a href="{{ url('city_master') }}" class="btn btn-primary btns" > <i class="fa fa-plus-circle"></i>Manage City</a>
                        </h5></center>
                            <hr>
                            <form method="post" action="{{route('citystore')}}">
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city"  class="form-control" placeholder="Name">
                                    </div>
