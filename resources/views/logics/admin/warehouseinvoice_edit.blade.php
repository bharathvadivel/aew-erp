                ...
                <div class="col-12 mt-4" style="margin-top:0!important;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form method="post" enctype="multipart/form-data" action="{{route('warehouseinvoice.csv.update')}}">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <select required="" id="warehouse_id" name="created_by" class="form-control">
                                                ...
                                                <option {{$fromwarehouse ? 'selected':''}} value="{{ $fromwarehouse ? $fromwarehouse->warehouse_id:'' }}">{{ $fromwarehouse ? $fromwarehouse->name:'' }}({{$fromwarehouse ? $fromwarehouse->warehouse_id:''}})</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <select required="" id="dis_id" name="dis_id" class="form-control ">
                                                <option value="">Select</option>
                                                <option {{ $towarehouse ? 'selected':''}} value="{{ $towarehouse ? $towarehouse->warehouse_id:'' }}">{{ $towarehouse ? $towarehouse->name:'' }}({{$towarehouse ? $towarehouse->warehouse_id:''}})</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input required="" minlength="10" maxlength="10" readonly type="text" value="{{ $towarehouse ? $towarehouse->phone:'' }}" name="phone" class="form-control phone" placeholder="Mobile Number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="bill_type" class="form-control">
                                                <option {{$row->bill_type==0 ? 'selected':'disabled'}} value="0">Invoice</option>
                                                <option {{$row->bill_type==1 ?  'selected':'disabled'}} value="1">Delivery Note</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" value="{{ $towarehouse ? $towarehouse->gstin_no:'' }}" class="form-control gstin_no" placeholder="Gstin NO">
                                        </div>
                                    </div>

                                    <input type="hidden" name="partner_type" value="{{ $row->partner_type }}" class="form-control">
                                    ...
                                    <div class="col-md-12 mb-12">
                                        <div class="form-group">
                                            ...
                                            <select required="" name="location_id" class="form-control selectsearch">
                                                <option value="">Select</option>
                                                <option selected value="{{ $towarehouse->location_id }}">{{ $towarehouse->address }}</option>
                                            </select>
                                ...
                                <div class="form-row" {{$row->ch_box_status=='ch_ked' ? 'style=display:none' : ''}} id="deliveryaddress">
                                    ...
                                    <div class="col-md-6 mb-6">
                                        <div class="form-group">
                                            ...
                                            <select required="" onchange="newDeliveryAddress(this.value)" name="delivery_location_id" class="form-control selectsearch" style="width: 590px">
                                                <option value="">Select Delivery Address</option>
                                                <option {{ $row->delivery_location_id=='new' ? 'selected':'' }} value="new">Add New</option>
                                                <option {{ $row->delivery_location_id!='new' ? 'selected' :'' }} value="{{ $towarehouse->location_id }}">{{ $towarehouse->address }}</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input value="0" type="number" min="0" name="partner_allowance" class="form-control partner_allowance" placeholder="Direct Partner Allowance">
                                                <span style="font-size:12px;color:red">Note: Enter Percentage Value</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input value="0" min="0" type="number" name="additional_discount" class="form-control additional_discount" placeholder="Addtional Discount">
                                                <span style="font-size:12px;color:red">Note: Enter Amount Value</span>
                                ...
                                <div id="entrysubmit" style="display:none">
                                    <center><button id="ajaxsubmit" class="btn btn-primary mt-4 pl-4 pr-4 btn-submit">Submit</button>
                                    </center>
...
*===========================-->
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e) {
            ...
            $.ajax({
                type: 'POST'
                , url: "{{ route('warehouseinvoice.update') }}"
                , data: {
                    disinvoice_no: disinvoice_no
                    , dis_id: dis_id
                    , bill_type: bill_type
