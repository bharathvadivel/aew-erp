...
<body onload="chnge('{{$whos}}')">
    ...
    <div class="main-content page-content">
        ...
        <div class="main-content-inner">
            ...
            <div class="row" id="direct_partner">
                <!-- Primary table -->
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('amount.collect.group.master')}}">
                                @csrf
                                <div class="form-row">
                                    <input type="hidden" name="whos" value="direct_partner" />
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <button class="btn" style="background-color:#ff4d4d">Direct Partners</button>
                            <button onclick="chnge('sub_dealer')" class="btn" style="background-color:#C0C0C0">Sub Dealers</button>
        ...
        <div class="row" style="display: none;" id="sub_dealer">
            <!-- Primary table -->
            <div class="col-12 mt-4">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{route('amount.collect.group.master')}}">
                            ...
                            <div class="form-row">
                                ...
                                <input type="hidden" name="whos" value="sub_dealer" />
            ...
            <div class="col-12 mt-4">
                <div class="card">
                    <div class="card-body">
                        <button class="btn" onclick="chnge('direct_partner')" style="background-color:#C0C0C0">Direct Partners</button>
                        <button class="btn" style="background-color:#ff4d4d">Sub Dealers</button>
                        ...
                        <div class="table-responsive datatable-primary">
                            <table id="dataTable" class="boh">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($row_sub_dealer as $key => $vl)
                                    @php
                                    $total_sale_amount=0;
                                    $total_return_amount=0;
                                    @endphp
                                    ...
                                    <tr>
                                       ...
                                       <td>{{ $outstanding }}</td>
                                        <td>
                                            <a href="{{ route('amount.collect.master', $vl->partner_id) }}"><i data-placement="top" title="View" class="fa fa-external-link" style="color:#056c91;margin: 10px;"></i></a>
                                        </td>
                                    </tr>
    ...
    <script>
        function chnge(type) {
            var type = type;
            if (type == 'sub_dealer') {
                document.getElementById("sub_dealer").style.display = 'block';
                document.getElementById("direct_partner").style.display = 'none';
            } else {
                document.getElementById("sub_dealer").style.display = 'none';
                document.getElementById("direct_partner").style.display = 'block';
            }
