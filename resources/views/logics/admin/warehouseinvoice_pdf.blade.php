                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <h4 style="text-align: right">{{$disinvoices[0]->bill_type==0 ? 'TAX INVOICE':'DELIVERY NOTE' }}</h4>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                ...
                                                                $billto = DB::table('warehouses')->where('warehouse_id',$dis_id)->first();
                                                                @endphp
                                                                <strong>Billed To:</strong><br>
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add">{{$billto->name}}</span>
                                                                </div>
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="ship">
                                                                ...
                                                                $new_delivery_address=$disinvoices[0]->new_delivery_address;
                                                                $shipped= DB::table('warehouses')->where('warehouse_id',$dis_id)->first();
                                                            ...
                                                            <div class="panel panel-default">
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table border="1" class="table borderclr table-bordered">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                $s_list=DB::table('serials')->where('disinvoices_id',$vl->id)->pluck('serial_no')->toArray();
                                                                ...
                                                                <div class="d-print-none">
                                                                    <div class="pull-right">
                                                                        <a href="{{url('invoice_pdf/'.$disinvoices[0]->disinvoice_no)}}" target="_blank" class="btn btn-success waves-effect waves-light "></i>Print</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
