                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="invoice-title-edit">
                                                        ...
                                                        <h4 style="font-size: 16px;" class="pull-right font-16"><strong>Invoice No:{{$deainvoices[0]->customerinvoice_no}}</strong></h4>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                @php
                                                                $partner_id=$deainvoices[0]->created_by;
                                                                $sub_location_id=$deainvoices[0]->sub_location_id;
                                                                $from = DB::table('distributors')->where('partner_id',$partner_id)->first();
                                                                $from_location = DB::table('userlocations')->where('partner_id',$partner_id)->where('location_id',$sub_location_id)->first();
                                                                @endphp
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">@if($from_location) {{$from_location->address}} @endif</span>
                                                        ...
                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                            <address class="ship">
                                                                ...
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add"><b></b>{{ $deainvoices[0]->customer_name }}</span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{ $deainvoices[0]->customer_phone }}</span>
                                                                </div>



                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{$deainvoices[0]->address}} </span>
                                                                </div>
                                                    ...
                                                    @php
                                                    $date=$deainvoices[0]->date!='' ? date('Y-m-d',strtotime($deainvoices[0]->date)):$date='---';
                                                            ...
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-2" style="padding: 0px;margin-top: 6px;">
                                                                        <label>Product Details :</label><label>Date: {{$date}}</label>
                                                                    </div>
                                                                        ...
                                                                        <table border="1" class="table borderclr table-bordered">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    @if($deainvoices[0]->state=='TAMILNADU' )
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                $s_list=DB::table('deaserials')->where('deainvoices_id',$vl->id)->pluck('serial_no')->toArray();
                                                                            ...
                                                                            <tr>
                                                                                <th rowspan="5" align="center" colspan="8"></th>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th class="text-right">{{number_format($deainvoices[0]->round_off,2)}}</th>
                                                                            </tr>
                                                                            <tr>
                                                                                <th colspan="2" class="text-right">Net Total</th>
                                                                                <th class="text-right">{{number_format($deainvoices[0]->grand_total,2)}}</th>
                                                                            </tr>
                                                                            <tr>
                                                                                <th colspan="12" style="text-transform: uppercase;word-break: break-all;">Amount in words : {{App\Http\Controllers\AdminController::words($deainvoices[0]->grand_total)}}</th>
                                                                ...
                                                                <div class="d-print-none">
                                                                    <div class="pull-right">
                                                                        <a href="{{url('customer_invoice/'.$deainvoices[0]->customerinvoice_no)}}" target="_blank" class="btn btn-success waves-effect waves-light "></i>Print</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
