                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly value="{{$invoice_no}}" type="text" name="invoice_no" class="form-control" placeholder="Invoice no">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly minlength="10" maxlength="10" type="text" value="{{ $row->service_center_phone }}" name="service_center_phone" class="form-control" placeholder="Mobile Number">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input  readonly type="text" value="{{ $row->service_center_address }}" name="service_center_address" class="form-control" placeholder="Address">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly type="text" value="{{ $row->service_center_city }}"  name="service_center_city" class="form-control" placeholder="City"></input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly type="text" value="{{ $row->service_center_district }}" name="service_center_district" class="form-control" placeholder="District"></input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly type="text" value="{{ $row->service_center_state }}" name="service_center_state" class="form-control" placeholder="State"></input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <table class="table table-striped text-center invoice">
                                                        <thead class="text-uppercase">
                                                            ...
                                                            <tbody>
                                                                @php
                                                                $grand_total=0;
                                                                $was=json_decode($row->part_code);
                                                                @endphp
                                                                @foreach ($was as $key=>$da)
                                                                @php
                                                                $ch_list = DB::table('parts')->where('part_code','=',$da)->first();
                                                                $gst=($ch_list->price/100) * $ch_list->gst_percentage;
                                                                $total=$ch_list->price+$gst;
                                                                $grand_total+=$total;
                                                                @endphp
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{$da}}</td>
                                                                    <td>{{$ch_list->part_name}}</td>
                                                                    <td>1</td>
                                                                    <td>{{$ch_list->price}}</td>
                                                                    <td>{{$ch_list->gst_percentage}}</td>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        ...
                                                                        <td></td>
                                                                            ...
                                                                            <td><button data-bs-toggle="modal" data-bs-target="#order_list" type="submit" class="btn btn-danger">Add Invoice</button></td>
...
<div class="modal fade" id="order_list" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('partorder.invoice.store',$id) }}" method="post">
                    @csrf
                    <input type="hidden" name="invoice_no" value="{{ $invoice_no }}">
   ...
   <div class="mb-3">
       <label for="recipient-name" class="col-form-label">Billing Address</label>
                       ...
                       <select  name="billing_service_id" class="form-control">
                           <option value="">Select</option>

                           @foreach ($service_center as $key)

                           <option value="{{ $key->service_id }}">{{ $key->address }}</option>
                           @endforeach
                    ...
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Part Status ({{$da}}):</label>

                        <select name="part_status[]" class="form-control">
