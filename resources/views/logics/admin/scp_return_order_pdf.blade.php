                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <div class="row">
                                                @php
                                                $login_id=$scp_invoices[0]->created_by;
                                                $from = DB::table('services')->where('service_id',$login_id)->first();
                                                @endphp

                                                <div class="col-md-12">
                                                    <h4 style="text-align: right">
                                                        @php
                                                            if ($scp_invoices[0]->scp_invoice_type == 'Return Invoice') {
                                                                echo 'RETURN ORDER: INVOICE';
                                                            } elseif ($scp_invoices[0]->scp_invoice_type == 'Return DC') {
                                                                echo 'RETURN ORDER: DELIVERY NOTE';
                                                            }
                                                        @endphp
                                                    </h4>
                                                    ...
                                                    <div class="invoice-title-edit">
                                                        ...
                                                        <h4 style="font-size: 19px;margin:-5px 0px 0px 100px" class="font-16"><strong>{{$from->service_center_name}}</strong></h4>
                                                        <h4 style="font-size: 16px;" class="font-16 pull-right"><strong>Invoice No:{{$scp_invoices[0]->scp_invoice_no}}</strong></h4>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                ...
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add">{{$from->service_center_name}}</span>
                                                                </div>
                                                                <div class="col-md-12 disp_addrs">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="bill">
                                                                @php
                                                                $to_id=$scp_invoices[0]->supplied_to;
                                                                $location_id=$scp_invoices[0]->location_id;
                                                                if($scp_invoices[0]->supplied_to_type=='Service Center'){
                                                                    $billto = DB::table('services')->where('service_id',$to_id)->first();
                                                                    $billto_name = $billto->service_center_name;
                                                                }
                                                                elseif($scp_invoices[0]->supplied_to_type=='Warehouse'){
                                                                    $billto = DB::table('warehouses')->where('warehouse_id',$to_id)->first();
                                                                    $billto_name = $billto->name;
                                                                }
                                                                @endphp
                                                                <strong>Billed To:</strong><br>
                                                                <div class="col-md-12 disp_addrs ">
                                                                    <span class="user_order_add">{{$billto_name}}</span>
                                                                </div>


                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{$billto->address}}</span>
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <address class="ship">
                                                                @php
                                                                    $to_id=$scp_invoices[0]->supplied_to;
                                                                    if($scp_invoices[0]->supplied_to_type=='Service Center'){
                                                                        $delivery_location_id=$scp_invoices[0]->delivery_location_id;
                                                                        $new_delivery_address=$scp_invoices[0]->new_delivery_address;
                                                                        $shipped= DB::table('services')->where('service_id',$to_id)->first();
                                                                    }
                                                                    elseif($scp_invoices[0]->supplied_to_type=='Warehouse'){
                                                                        $delivery_location_id=$scp_invoices[0]->delivery_location_id;
                                                                        $new_delivery_address=$scp_invoices[0]->new_delivery_address;
                                                                        $shipped= DB::table('warehouses')->where('warehouse_id',$to_id)->first();
                                                                    }
                                                                    $delivery_address=$shipped->address;
                                                                @endphp
                                                                <strong>Shipped To:</strong><br>

                                                                <div class="col-md-12 disp_addrs">
                                                                    <span class="user_order_add">{{ $delivery_location_id=='new' ? $new_delivery_address:$delivery_address}} </span>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        @php
                                                            $by_order_no=$scp_invoices[0]->by_order_no!='' ?$scp_invoices[0]->by_order_no :$by_order_no='---';
                                                            $date=$scp_invoices[0]->date!='' ? date('d-m-Y',strtotime($scp_invoices[0]->date)):$date='---';
                                                            $ew_bill_no=$scp_invoices[0]->ew_bill_no!='' ? $scp_invoices[0]->ew_bill_no:$ew_bill_no='---';
                                                            $others=$scp_invoices[0]->others!='' ? $scp_invoices[0]->others:$others='---';
                                                        @endphp
                                                            ...
                                                            <div class="panel panel-default">
                                                                        ...
                                                                        <table border="1" class="table borderclr table-bordered">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    @if($scp_invoices[0]->state=='TAMILNADU' )
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                $set_tcs_total=0;
                                                                                @endphp
                                                                                @foreach ($scp_invoices as $key=>$vl)
                                                                                    @php
                                                                                    ...
                                                                                    $s_list=DB::table('scp_serials')->where('scp_return_no',$vl->scp_invoice_no)->pluck('serial_no')->toArray();
                                                                                ...
                                                                                @endforeach
                                                                                @if ($scp_invoices[0]->tcs!=0)
                                                                                @php
                                                                                $set_total=$set_tcs_total;
                                                                                $net_total=$pay+$set_total;
                                                                                $set_tcs=$scp_invoices[0]->tcs."%";
                                                                                @endphp
                                                                                @else
                                                                                @php
                                                                                $set_total=0;
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="text-right">{{number_format($scp_invoices[0]->round_off,2)}}</th>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="text-right">{{number_format($scp_invoices[0]->grand_total,2)}}</th>
                                                                                ...
                                                                                <tr>
                                                                                    <th colspan="11" style="text-transform: uppercase;word-break: break-all;">Amount in words : {{App\Http\Controllers\AdminController::words($scp_invoices[0]->grand_total)}} ONLY</th>
                                                                ...
                                                                <div class="d-print-none">
                                                                    <div class="pull-right">
                                                                        <a href="{{url('scp_return_order_pdf/'.$scp_invoices[0]->scp_invoice_no)}}" target="_blank" class="btn btn-success waves-effect waves-light "></i>Print</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
