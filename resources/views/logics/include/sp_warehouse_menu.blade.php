    ...
    <ul class="submenu">
        ...
        <li>
            <a href="{{route('service.center.serials.stock')}}">
                <i class="feather feather-check-square"></i>
                <span>Service Centers Stock</span>
            </a>
        </li>
...
<li>
    ...
    <ul class="submenu">
        ...
        <li>
            <a href="{{route('warehouse.scpinvoice')}}">
                <i class="feather feather-check-square"></i>
                <span>Service Center Invoice</span>
            </a>
        </li>
        <li>
            <a href="{{route('scpinvoice.master')}}">
                <i class="feather feather-check-square"></i>
                <span>Manage SCP Invoices</span>
            </a>
        </li>
