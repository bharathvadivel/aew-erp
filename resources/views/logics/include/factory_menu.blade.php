        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="{{route('partorder.master')}}"><i class="ion-ios-folder-outline"></i><span>Spare Parts Order</span></a>
                </li>

                <li><a href="{{route('partorder.invoice.master')}}"><i class="ion-ios-folder-outline"></i><span>Spare Parts Invoice</span></a>
                </li>
